  ...
  <div>
    <div class="not-started" v-if="!started">
      <a-row :gutter="10" style="padding-top: 40px">
        ...
        <a-col :lg="12" :sm="32" :xs="32" class="leader-wrap">
          <div class="bordered">
            <p class="login-header" style="font-size: 20px; border-bottom: 1px solid #eee; padding-bottom: 12px;">Start Examination</p>
    ...
    <div class="started" v-else>
      <div>
        ...
        <flip-countdown style="margin-bottom: 20px; position: absolute; right: 30px;margin-top: -30px" :deadline="newTime" />
      </div>
      ...
      <div style="margin: 100px 2% 2%; padding: 2%;">
        ...
        <div class="steps-action">
          ...
          <a-button style="margin-left: 12px;" type="primary" @click="next" :disabled="current === questions.length - 1">Next</a-button>
